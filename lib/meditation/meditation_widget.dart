...
class _MeditationWidgetState extends State<MeditationWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MEDITATION_PAGE_Meditation_ON_PAGE_LOAD');
      logFirebaseEvent('Meditation_revenue_cat');
      ...
      if (isEntitled) {
        logFirebaseEvent('Meditation_navigate_to');

        context.pushNamed('Meditation_purchased');

        return;
      } else {
        logFirebaseEvent('Meditation_revenue_cat');
        final isEntitled =
            await revenue_cat.isEntitled('Meditation_mini_course_access');
        if (isEntitled == null) {
          return;
        } else if (!isEntitled) {
          await revenue_cat.loadOfferings();
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          InkWell(
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'MEDITATION_Container_lp553nus_ON_TAP');
                                                              logFirebaseEvent(
                                                                      ...
                                                                      Stack(
                                                                        children: [
                                                                          InkWell(
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('MEDITATION_PAGE_getaccess_ON_TAP');
                                                                              logFirebaseEvent('getaccess_navigate_to');

                                                                              context.pushNamed(
                                                                                'Meditation_page_blocked',
                                                                                queryParams: {
                          ...
                          child: Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MEDITATION_PAGE_Icon_utx5b82g_ON_TAP');
                              ...
                              InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MEDITATION_PAGE_Icon_61xbnj9r_ON_TAP');
                                  logFirebaseEvent('Icon_navigate_to');
                              ...
                              InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MEDITATION_PAGE_Icon_z63gz2h8_ON_TAP');
                                  logFirebaseEvent('Icon_navigate_to');
                              ...
                              InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MEDITATION_PAGE_Column_1uldyqo8_ON_TAP');
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    InkWell(
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MEDITATION_PAGE_Icon_h7v14f00_ON_TAP');
                                        logFirebaseEvent('Icon_navigate_to');
                              ...
                              InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MEDITATION_PAGE_Icon_tsbe97q4_ON_TAP');
                                  logFirebaseEvent('Icon_navigate_to');
